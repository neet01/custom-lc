...
const slackArchiveEnabled = isEnabled(process.env.SLACK_ARCHIVE_ENABLED);
const teamsArchiveEnabled = isEnabled(process.env.TEAMS_ARCHIVE_ENABLED);
...
function buildSharedPayload() {
  ...
  const payload = {
    appTitle: process.env.APP_TITLE || 'Cortex',
